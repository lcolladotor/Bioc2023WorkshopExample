# Getting help with `Bioc2023WorkshopExample`

Thank you for using `Bioc2023WorkshopExample`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/Bioc2023WorkshopExample`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/Bioc2023WorkshopExample),
...
[search issues and pull requests](https://github.com/lcolladotor/Bioc2023WorkshopExample/issues)
